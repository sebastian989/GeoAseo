...
public class L_RegistrarPeaje extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		if(v.getId()== R.id.btnTollA){
			...
			if(this.ticket.getText().toString().equals("") || this.typeToll.equals("")){
				Utilities.showAlert(this,"INTRODUCE EL NUEMRO DE TICKET Y SELECCIONA UN TIPO DE PEAJE PARA CONTINUAR");
			}
			else{
				try {
					
					this.adb.setTitle("SEGURO QUE PAGO UN PEAJE TIPO "+this.typeToll);
	...
	public void inicializeObjects(){
		...
		this.dTollATwo = this.getResources().getDrawable(R.drawable.btn_toll_a_two);
		this.dTollB = this.getResources().getDrawable(R.drawable.btn_toll_b);
		this.dTollBTwo = this.getResources().getDrawable(R.drawable.btn_toll_b_two);
		this.dTollC = this.getResources().getDrawable(R.drawable.btn_toll_c);
		this.dTollCTwo = this.getResources().getDrawable(R.drawable.btn_toll_c_two);
